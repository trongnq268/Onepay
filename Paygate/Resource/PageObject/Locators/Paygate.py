radioDomestic = "id:domescard-radio"
listBank = "xpath:(//div[@class='left'])"
titleCard = "xpath://div[@class='d_title_card']"


# message errorm
msgErrorCardNumne = "xpath://div[@class='form-field form-field-big']//span[@class='error']"
